...
namespace ubnhs_lms.addForms
{
    public partial class addSuppliers: Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(supplier) || string.IsNullOrWhiteSpace(address) ||
                string.IsNullOrWhiteSpace(contactNo) || string.IsNullOrWhiteSpace(email))
            {
            ...
            using (MySqlConnection conn = new MySqlConnection(classDatabase.ConnectionString))
            {
                ...
                string checkQuery = "SELECT COUNT(*) FROM suppliers WHERE SupplierName = @SupplierName AND Address = @Address";
                MySqlCommand checkCmd = new MySqlCommand(checkQuery, conn);
                checkCmd.Parameters.AddWithValue("@SupplierName", supplier);
                ...
                {
                    string query = "INSERT INTO suppliers (SupplierName, Address, ContactNo, Email) VALUES (@SupplierName, @Address, @ContactNo, @Email)";
                    ...
                    formSuppliers formSupplier = Application.OpenForms["formSuppliers"] as formSuppliers;
                    if (formSupplier != null)
                    {
                        formSupplier.LoadSuppliers();
                    }
                }
            }
        }
